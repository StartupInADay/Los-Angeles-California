...
(function (Drupal, debounce, CKEDITOR, $) {
  ...
  Drupal.editors.ckeditor = {
    ...
    _loadExternalPlugins: function (format) {
      var externalPlugins = format.editorSettings.drupal.externalPlugins;
      // Register and load additional CKEditor plugins as necessary.
      if (externalPlugins) {
        for (var pluginName in externalPlugins) {
          if (externalPlugins.hasOwnProperty(pluginName)) {
            CKEDITOR.plugins.addExternal(pluginName, Drupal.settings.basePath + externalPlugins[pluginName]['path'] + '/', externalPlugins[pluginName]['file']);
          }
        }
        delete format.editorSettings.drupal.externalPlugins;
      }
    }
  ...
  Drupal.ckeditor = {
    ...
    openDialog: function (editor, url, existingValues, saveCallback, dialogSettings) {
      ...
      dialogSettings.autoResize = Drupal.ckeditor.checkWidthBreakpoint(600);
   ...
   */
  Drupal.ckeditor.checkWidthBreakpoint = function (width) {
