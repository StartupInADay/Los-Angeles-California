 ...
 * - require a data-entity-type and a data-entity-id attribute (which Drupal
  ...
  CKEDITOR.plugins.add('drupalimage', {
    ...
    beforeInit: function (editor) {
      ...
      editor.on('widgetDefinition', function (event) {
        ...
        requiredContent.attributes['data-entity-id'] = '';
        widgetDefinition.requiredContent = new CKEDITOR.style(requiredContent);
        widgetDefinition.allowedContent.img.attributes['!data-entity-type'] = true;
        widgetDefinition.allowedContent.img.attributes['!data-entity-id'] = true;
